    ...
    if (!class_tables[0]) {
      ...
      CamlinternalOO.set_methods($$class, /* array */[
            ...
            (function (self$1, scene) {
                ...
                return Curry._2(env$1[0][/* check_collisions */4], self$1, Caml_oo_curry.js2(-746899837, 2, scene, /* () */0));
              }),
            accel,
...
function check_collisions(obj, renderables) {
  return $$Array.iter((function (r) {
                if (r !== obj && Core$Sweenyville.collision(r, obj)) {
